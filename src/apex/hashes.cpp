...
// }
//
// std::optional<std::string_view> find_name(const uint32 key) {
//     return find_name(key);
// }
//
// std::optional<std::string_view> find_name(const uint64 key) {
...
// }
//
// std::optional<std::string> find_name(const uint32 key) {
...
//     return check_hash_presence(key);
// }
//

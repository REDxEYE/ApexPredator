...
void collect_types(ArchiveManager *archive_manager, Havok_TypeLibrary *lib) {
    ...
    String namespace_ = {};
    String_from_cstr(&namespace_, "HAVOK_TYPES");
    ...
    //
    String_from_cstr(&header_path, "D:/projects/cpp/ApexPredator/src/havok/generated/havok_generated.cpp");
    Path_convert_to_wsl(&header_path);
    Path_ensure_parent_dirs(&header_path);
    ...
    Havok_TypeLibrary_generate_code(lib, &namespace_, header_file, &header_rel_path, impl_file);
